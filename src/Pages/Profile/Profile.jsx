            ...
            <div className='rounded-md   bg-[#FEFEFE]'>
                ...
                <div className="flex items-center justify-center gap-6 mb-6">
                    <p
                        ...
                        className={`
                        ${tab === "Profile" ? "border-[#CD9B3A] border-b-2 font-semibold text-[#CD9B3A]" : "border-b-2 border-transparent font-normal text-gray-600"}
                    ...
                    <p
                        ...
                        className={`
                        ${tab === "Change Password" ? "border-[#CD9B3A] border-b-2 font-semibold text-[#CD9B3A]" : "border-b-2 border-transparent font-normal  text-gray-600"}
                ...
                </div>
                {
                    tab === "Profile"
                        ...
                        >
                            <h1 className='text-center text-[#CD9B3A] leading-7 text-2xl font-medium mb-7'>Edit Your
                                Profile</h1>
                            <Form
                        ...
                        >
                            <h1 className='text-center text-[#CD9B3A] leading-7 text-2xl font-medium mb-7'>Edit Your Profile</h1>
                            <Form
                                layout='vertical'
                                onFinish={onFinish}
                                form={form}
