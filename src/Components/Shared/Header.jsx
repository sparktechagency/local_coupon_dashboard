...
import { useGetNotificationCountQuery, useGetProfileQuery } from '../../redux/api/authApi';
const Header = () => {
  ...
  return (
    ...
    <div className='relative'>
        ...
        <p className='absolute top-0 -right-3 bg-[#cd9b3a] p-1 rounded-full h-6 w-6 text-center'>{count?.data?.count}</p>
    </div>
